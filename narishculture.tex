...
\section{Food traditions in modern times}

It's customary to eat communally with the rest of your commune, at least for large meals like lunch or dinner. In more modern contexts with people moving out of their communes and into more urban settings, eating out is extremely common. Sitting and eating alone is generally frowned upon, so it's not uncommon in *restaurant* restaurants to sit down with an exiting group or form ad hoc gatherings with others. 

There's a specific term for this kind of communal dining

\chapter{Communes and other living accomodations}

Most native Narish people live in communes with their extended families, often with one or two other families. In urban settings, a type of apartment called SOMETHING OR ANOTHER with separate bedrooms but communal everything else is very common, and residents of the apartment operate in the same way as a more traditional commune.
