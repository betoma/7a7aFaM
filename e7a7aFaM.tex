...
\begin{table}[ht]
    ...
    5. & {\rootpart}a{\rootpart}a & Primary attribute & \famword{}{s}{a}{fr}{a} & hot \emph{(cf. \famword{}{s}{a}{fr}{} `heat')} \\
    6. & {\rootpart}ana{\rootpart} & Person of X, Agentive noun & \famword{}{k}{ana}{j}{} & author \emph{(cf. \textsc{k}ii\textsc{y} `to write X')}\\
    ...
    9. & i{\rootpart}u{\rootpart}a & Place of X/with X attribute & \famword{i}{h}{u}{t}{a} & night \emph{(cf. \textsc{h}a\textsc{t}a `dark')} \\
    10. & m{\rootpart}i{\rootpart} & Instrument, tool & \famword{m}{r}{i}{q}{} & weapon \emph{(cf. \textsc{r}a\textsc{q} `pain')} \\
    ...
    17. & {\rootpart}uu{\rootpart} & Country/people group & \famword{}{n}{uu}{rk}{} & Norway \emph{(cf. \famword{}{n}{a}{rk}{a} `cold')} \\
    18. & {\rootpart}u{\rootpart}i & Color & \famword{}{k}{u}{w}{i} & yellow \emph{(cf., \famword{}{k}{aju}{w}{a} `leaf')} \\
    ...
    21. & u{\rootpart}i{\rootpart}i & Emotion, experiential & \famword{u}{n}{i}{m}{i} & hungry \textit{(cf. \famword{}{n}{a}{m}{a}, `filling')}
    \end{tabular}
