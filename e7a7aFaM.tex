...
\ex
\famword{}{c}{a}{kl}{as} nas kaj!\\
\textit{`I want the chocolate one!'}
\xe
...
tui[on\_surface\_of]
\famword{}{f}{ii}{l}{ami}[notice\_oneself]
-\lilglot[\textsc{con}]
dak[can]
...
Information that has been obtained through the retelling by a secondary party is marked with \emph{ir-}.
...
hwa-[\textsc{infer-}]@
\famword{}{n}{ii}{w}{}[died]
\glft `The cow was seemingly killed here.'
\endgl
\xe
...
\glft `The children are probably asleep by now.'
\endgl
\xe
