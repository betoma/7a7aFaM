...
\paragraph{Connective verbs} may be either finite or non-finite. They work in conjunction with the head verb to describe concurrent or subsequent actions, or to modify the meaning of the verb clause with auxilliary verbs.
...
\section{Auxilliary verbs}

\subsection{\emph{snak} - hortative}

from WeSiiN → sin → sinak → snak
...
in subordinate clauses, sth like "would do X"?
