...
\begin{description}[leftmargin=*]
    ...
    \begin{description}[labelwidth=*]
        ...
        \begin{quote}
            ha \textsc{mark} \textsc{k}a\textsc{j} men a\textsc{k}i\textsc{l}uila\\
    ...
    \begin{enumerate}
        ...
        \begin{quote}
            i\textsc{m}u\textsc{nt}a daw nas i\textsc{y}aa\textsc{t}e\lilglot{} kaj da buse fit i\textsc{k}aa\textsc{l}\\
