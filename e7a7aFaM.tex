...
\begin{table}[ht]
    ...
    \begin{tabular}{>{\em}rlll}
        ...
        \midrule
        \nm-    & Direct Witness    & \famword{i}{n}{aa}{m}{e\lilglot} jaa      & \textit{`they've eaten'} \\
        ir-     & Reportative       & ir\famword{i}{n}{aa}{m}{e\lilglot} jaa   & \textit{`they've eaten, they said'} \\
        hwa-    & Inferential       & hwa\famword{i}{n}{aa}{m}{e\lilglot} jaa  & \textit{`they've eaten, judging by the crumbs'} \\
        qaa-    & Internal/Assumed  & qaa\famword{i}{n}{aa}{m}{e\lilglot} jaa  & \textit{`they've probably eaten, it's after dinner time'} \\
        \bottomrule
    \end{tabular}
...
If the speaker hasn't observed an event themselves and is interpolating from current circumstances, they may use \emph{wha-} to mark 
