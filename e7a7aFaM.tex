...
\begin{dictroot}{b}{t}
    \begin{dictentry}{\famword{}{b}{ii}{t}{}}{\textit{v.tr.}}
        \dictdef{%
    ...
    \end{dictentry}
    \begin{dictentry}{\famword{i}{b}{aa}{t}{}}{\textit{v.intr.}}
        \dictdef{%
...
\begin{dictroot}{dr}{p}
    \begin{dictentry}{\famword{}{dr}{a}{p}{}}{\textit{n.}}
        \dictdef{%
        bad accent
        }
        \dictdef{%
    ...
    \end{dictentry}
    \begin{dictentry}{\famword{}{dr}{ii}{p}{}}{\textit{v.}}
        \dictdef{%
        to mimic \textit{sme.}, make fun of \textit{sme.}
        }
    \end{dictentry}
    \begin{dictentry}{\famword{i}{dr}{aa}{p}{}}{\textit{v.}}
        \dictdef{%
...
\begin{dictroot}{f}{m}
    ...
    \end{dictentry}
    \begin{dictentry}{\bigglot a\bigglot a\famword{}{f}{a}{m}{}}{n.}
