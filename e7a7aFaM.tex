...
\newcommand{\whatisthisfuckery}{\thenumbertable.}
...
\begin{table}[p]
    ...
    \wtf{
        \famword{}{\rootpart}{a}{\rootpart}{} & %
        Abstract noun & %
        \famword{}{j}{a}{b}{} & %
        good fortune \emph{(cf. \famword{}{j}{a}{b}{a} `good, fortunate')}
    }
    \wtf{
        \famword{}{\rootpart}{ii}{\rootpart}{} & %
        Transitive verb & %
        \famword{}{f}{ii}{s}{} & %
        to give birth to \emph{(cf. \textsc{f}ana\textsc{s} `person')}
    }
    \wtf{
        \famword{}{\rootpart}{iya}{\rootpart}{} & %
        Unaccusative verb & %
        \famword{}{k}{iya}{l}{} & %
        to be poured out \emph{(cf. \famword{}{k}{ar}{l}{i} `water')}
    }
    \wtf{
        \famword{i}{\rootpart}{aa}{\rootpart}{} & %
        Unergative verb & %
        \famword{i}{n}{aa}{m}{} & %
        to eat \emph{(cf. \famword{}{n}{ii}{m}{} `to eat (smth.)')}
    }
    \wtf{
        \famword{\rootpart$_1$i}{\rootpart$_1$}{iya}{\rootpart$_2$}{} & %
        Causative of unaccusative & %
        \famword{\textsc{k}i}{k}{iya}{l}{} & %
        to pour (smth.) out \emph{(cf. \famword{}{k}{iya}{l}{} `to flow out')}
    }
    \wtf{
        \famword{aa}{\rootpart}{i}{\rootpart}{} & %
        Causative of unergative & %
        \famword{aa}{n}{i}{m}{} & %
        to feed \textit{(cf. \famword{i}{n}{aa}{m}{} `to eat')}
    }
    \wtf{
        \famword{}{\rootpart}{a}{\rootpart}{a} & %
        Attributive & %
        \famword{}{s}{a}{fr}{a} & %
        hot \emph{(cf. \famword{}{s}{a}{fr}{} `heat')}
    }
    \wtf{
        \famword{}{\rootpart}{ana}{\rootpart}{} & %
        Person of X & %
        \famword{}{k}{ana}{j}{} & %
        author \emph{(cf. \textsc{k}ii\textsc{y} `to write (smth.)')}
    }
    \wtf{
        \famword{}{\rootpart}{ur}{\rootpart}{i} & %
        Object & %
        \famword{}{n}{ur}{m}{i} & %
        food \emph{(cf. \famword{i}{n}{aa}{m}{} `to eat')}
    }
    \wtf{
        \famword{}{\rootpart}{ar}{\rootpart}{i} & %
        Liquid noun & %
        \famword{}{q}{ar}{f}{i} & %
        coffee \emph{(cf. i\textsc{q}aa\textsc{f} `to drink coffee')} 
    }
    \wtf{
        \famword{i}{\rootpart}{u}{\rootpart}{a} & %
        Place of X & %
        \famword{i}{h}{u}{t}{a} & %
        night \emph{(cf. \famword{}{h}{a}{t}{a} `dark')}
    }
    \wtf{
        \famword{m}{\rootpart}{i}{\rootpart}{} & %
        Tool/instrument & %
        \famword{m}{r}{i}{q}{} & %
        weapon \emph{(cf. \textsc{r}a\textsc{q} `pain')}
    }
    \wtf{
        \famword{in}{\rootpart}{i}{\rootpart}{} & %
        Diminutive & %
        \famword{in}{f}{i}{m}{} & %
        word \textit{(cf. \famword{}{f}{a}{m}{} `language')}
    }
    \wtf{
        \famword{}{\rootpart}{uli}{\rootpart}{} & %
        Body part & %
        \famword{}{b}{uli}{t}{} & %
        head \emph{(cf. \famword{i}{b}{aa}{t}{} `to understand')}
    }
    \wtf{
        \famword{}{\rootpart}{u}{\rootpart}{u} & %
        Animal & %
        \famword{}{c}{um}{p}{u} & %
        kangaroo \emph{(cf. \famword{i}{c}{aa}{m}{p} `to jump')}
    }
    \wtf{
        \famword{}{\rootpart}{asi}{\rootpart}{} & %
        Long, slender object & %
        \famword{}{n}{asi}{rk}{} & %
        icicle \emph{(cf. \famword{}{n}{u}{rk}{i} `snowball')}
    }
    \wtf{
        \famword{}{\rootpart}{aju}{\rootpart}{a} & %
        Flat object or surface & %
        \famword{}{d}{aju}{l}{a} & %
        mirror \emph{(cf. \famword{}{d}{ii}{l}{} `to stare at')}
    }
    \wtf{
        \famword{}{\rootpart}{idi}{\rootpart}{} & %
        Loose, granular mass & %
        \famword{}{w}{idi}{w}{} & %
        sugar \emph{(cf. \textsc{w}a\textsc{w}a `sweet')}
    }
    \wtf{
        \famword{a}{\rootpart}{i}{\rootpart}{u} & %
        Closed/natural container & %
        \famword{a}{b}{i}{rd}{u} & %
        bird's nest \emph{(cf. \famword{}{b}{u}{rd}{u} `bird')} 
    }
    \wtf{
        \famword{}{\rootpart}{imi}{\rootpart}{u} & %
        Open/unnatural container & %
        \famword{}{q}{imi}{f}{u} & %
        coffee mug \emph{(cf. \famword{a}{q}{i}{f}{u} `coffee pot')}
    }
    \wtf{
        \famword{}{\rootpart}{u}{\rootpart}{i} & %
        Color & %
        \famword{}{k}{u}{w}{i} & %
        green \emph{(cf., \famword{}{k}{aju}{w}{a} `leaf')}
    }
    \wtf{
        \famword{u}{\rootpart}{i}{\rootpart}{i} & %
        Experiential & 
        \famword{u}{n}{i}{m}{i} & 
        hungry \emph{(cf. \famword{}{n}{a}{m}{a} `satisfying')}
    }
    \wtf{
        \famword{}{\rootpart}{uu}{\rootpart}{} & %
        People group, land of X people & %
        \famword{}{n}{uu}{rk}{} & %
        Nords, Norse, Norway \emph{(cf. \famword{}{n}{a}{rk}{a} `cold')}
    }
    \wtf{
        \famword{}{\rootpart}{a}{\rootpart}{ia} & %
        Nationstate & %
        \famword{}{fr}{a}{nc}{ia} & %
        France \emph{(cf. \famword{}{fr}{uu}{nc}{} `Franks')}
    }
    \end{tabular}
...
%\begingl
%\glpreamble
ha \textsc{Knut} \famword{in}{f}{i}{s}{uru}.\\
%\endpreamble
%\glft
Knut is a baby.
%\endgl
...
\begingl
\glpreamble
ha \textsc{Knut} li \famword{}{b}{a}{c}{a} \famword{in}{f}{i}{s}{uruli}?
\endpreamble
ha[\sc ref.m]
\textsc{Knut}[Knut]
li[which]
\famword{}{b}{a}{c}{a}[small]
\famword{in}{f}{i}{s}{}[baby]@
-uru[\sc -cop]@
-li[\sc -int]
\glft
...
When describing a quantity of something, often one may desire to use a particular noun as a measure of another. While many languages (English included) turn the measured substance into an adpositional phrase modifying the measure word as the head, in \lang{} one turns the measure word into an adjective modifying the substance being measured using the suffix \emph{-lat}. For instance, \emph{\famword{}{k}{imi}{l}{u}} `glass' becomes \emph{\famword{}{k}{imi}{l}{ulat}} `a glass of' in \emph{\famword{}{k}{imi}{l}{ulat} \famword{}{m}{ar}{h}{i}} `glass of milk'
...
\begingl
\glpreamble
pars bar \famword{a}{k}{i}{l}{ulat} \famword{}{k}{ar}{l}{i} \famword{}{k}{ii}{l}{}.
\endpreamble
pars[\sc 3.med]
bar[three]
\famword{a}{k}{i}{l}{u}[bottle]@
-lat[\sc -meas]
\famword{}{k}{ar}{l}{i}[water]
...
When one thing is constructed from/comprised of a particular material, one can indicate this by taking the noun of the material in question and turning it into an adjective using the suffix \emph{-aki}---for instance, \textit{\famword{}{r}{u}{rkd}{i}} `wood' becomes \textit{\famword{}{r}{u}{rkd}{iaki}} `wooden'. 

\ex
\begingl
\glpreamble%
nas \famword{}{m}{aju}{w}{aaki} \famword{i}{f}{u}{s}{airi}%
\endpreamble%
nas[\sc 1sg]
\famword{}{m}{aju}{w}{a}[playing\_card]@
-aki[-made\_of]
...
\begingl
\glpreamble
A: mi li \famword{}{m}{asi}{h}{} \famword{}{n}{ii}{m}{e\lilglot} kajli? \textit{(`Which ice cream bar do you want to eat?')}\\
B: \famword{}{c}{a}{kl}{as} nas kaj!%
\endpreamble
\famword{}{c}{a}{kl}{a}[chocolate]@
-s[\sc -nmz]
nas[\sc 1sg]
kaj[want]
...
\begingl
naswi[\textsc{1ex}]
\famword{}{k}{aju}{l}{a}[water\_surface]
tui[on\_surface\_of]
\famword{}{f}{ii}{l}{}[notice]@
-ami[\sc -refl]@
-\lilglot[-\textsc{cvb}]
dak[can]
...
nas[\textsc{1s}]
bu[that]
\famword{}{n}{u}{w}{u}[possum]
\famword{}{r}{ii}{q}{}[hit]
-e\lilglot[\textsc{con}]
\famword{}{l}{a}{w}{}[up]
daw[towards]
\famword{i}{c}{aa}{n}{}[climb]
...
\begin{table}[ht]
    ...
    \begin{tabular}{>{\em}rlll}
        ...
        \midrule
        \nm-    & Direct Witness    & \famword{i}{n}{aa}{m}{}     & \textit{`they're eating'} \\
        ir\,-     & Reportative       & ir\famword{i}{n}{aa}{m}{}   & \textit{`they're eating, they said'} \\
        hwa-    & Inferential       & hwa\famword{i}{n}{aa}{m}{}  & \textit{`they're eating, judging by the smell'} \\
        qaa-    & Internal/Assumed  & qaa\famword{i}{n}{aa}{m}{}  & \textit{`they're probably eating, it's around dinner time'} \\
        \bottomrule
    \end{tabular}
...
\ex
\begingl
\glpreamble \famword{}{f}{ana}{s}{aj} \famword{ir}{m}{a}{l}{aurutu} \famword{i}{n}{aa}{m}{e\lilglot} jaa.
\endpreamble
\famword{}{f}{ana}{s}{aj}[man]
ir-[\textsc{rep-}]@
\famword{}{m}{a}{l}{aurutu}[ill:\textsc{cop:rel}]
\famword{i}{n}{aa}{m}{e\lilglot}[eat:\textsc{con}]
jaa[indeed]
\glft `The man, who I was told was sick, was eating after all.'\\
\endgl
\xe

In the above example, the evidential attaches to and scopes over only the relative clause \emph{`\famword{}{f}{ana}{s}{aj} \famword{}{m}{a}{l}{aurutu}'}, leaving the matrix clause unmodified. 
...
\ex
\begingl
\famword{in}{f}{i}{s}{}[children]
qaa-[\textsc{inter-}]@
\famword{i}{s}{aa}{j}{}[sleep]
...
\pex
\a
ha \textsc{Karl}-la fu \textsc{Janne} \famword{i}{l}{aa}{f}{}\\
\textit{`Karl \& Janne are in love.'}
\a
pars \textsc{Karl} baj \famword{i}{m}{aa}{h}{}\\
\textit{`His name is Karl.'}
\a
\textsc{Karl}, \famword{i}{w}{aa}{b}{ak}!\\
