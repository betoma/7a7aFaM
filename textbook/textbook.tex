...
\newcommand{\diagline}[3]{\hspace{2em} \textbf{\uppercase{#1:}} {#2} \textit{`#3'} \\}
...
Whether you want to learn more about \langeng{} culture, move to \landeng{}, or just communicate with your \langeng{} friends, we hope this textbook will give you an approachable yet thorough introduction to the \langeng{} language! By the end of this book you'll be able to navigate almost anything from everyday situations to even nuanced philosophical quandries of life.
...
\begin{conversation}
    \diagline{A}{\famword{FaSajara}.}{Hello.}
    \diagline{B}{\famword{FaSunara}.}{Hello.}
\end{conversation}
...
\begin{conversation}
    \diagline{a}{\famword{FaSajara, nas ha KNUTuru.}}{Hello, I am Knut.}
    \diagline{b}{\famword{KNUT FaSunara, nas fu BETHANYuru.}}{Hi Knut, I am Bethany.}
\end{conversation}
...
\begin{conversation}
    \diagline{a}{\famword{QarFi KiiLli?}}{do you drink coffee?}
    \diagline{b}{\famword{KiiL.}}{[Yes,] I drink.}
    \diagline{b}{\famword{da PurNi NiiMli?}}{but do you eat bread?}
    \diagline{a}{\famword{NiiM.}}{[Yes,] I eat.}
\end{conversation}

If you need to disagree with someone's question, you simply use the word \emph{hwii}:

\begin{conversation}
    \diagline{a}{\famword{MarHi KiiLli?}}{Do you drink milk?}
