...
\begin{dictroot}{t}{lw}
    ...
    \end{dictentry}
    \begin{dictentry}{\famword{iTaaLW}}{v.intr.}
        \dictdef{
    ...
    \end{dictentry}
    \begin{dictentry}{\famword{TiiLW}}{v.tr.}
        \dictdef*{
            to bury \textit{smth.}
        }
    \end{dictentry}
    \begin{dictentry}{\famword{aaTiLW}}{v.tr.}
        \dictdef{
    ...
    \end{dictentry}
    \begin{dictentry}{\famword{TaLWa}}{adj.}
        \dictdef{
    ...
    \end{dictentry}
    \begin{dictentry}{\famword{TanaLW}}{n.}
        \dictdef{
            farmer
        }
        \dictdef{
    ...
    \end{dictentry}
    \begin{dictentry}{\famword{TurLWi}}{n.}
        \dictdef*{
            potato
        }
    \end{dictentry}
    \begin{dictentry}{\famword{TarLWi}}{n.}
        \dictdef*{
            mud
        }
    \end{dictentry}
    \begin{dictentry}{\famword{iTuLWa}}{n.}
        \dictdef*{
            section of land
        }
    \end{dictentry}
    \begin{dictentry}{\famword{mTiLW}}{n.}
        \dictdef*{
            spade, shovel
        }
    \end{dictentry}
    \begin{dictentry}{\famword{inTiLW}}{n.}
        \dictdef*{
            island
        }
    \end{dictentry}
    \begin{dictentry}{\famword{TuLWu}}{n.}
        \dictdef*{
            mole
        }
    \end{dictentry}
    \begin{dictentry}{\famword{TasiLW}}{n.}
        \dictdef{
            hill, mound
        }
        \dictdef{
    ...
    \end{dictentry}
    \begin{dictentry}{\famword{TajuLWa}}{n.}
        \dictdef{
            the ground, soil
        }
        \dictdef{
    ...
    \end{dictentry}
    \begin{dictentry}{\famword{TidiLW}}{n.}
        \dictdef*{
            actual dirt
        }
    \end{dictentry}
    \begin{dictentry}{\famword{TuLWi}}{n., adj.}
        \dictdef*{
            brown, the color brown
        }
    \end{dictentry}
    \begin{dictentry}{\famword{aTiLWu}}{n.}
        \dictdef*{
            grave, burial pit
        }
    \end{dictentry}
    \begin{dictentry}{\famword{TimiLWu}}{n.}
        \dictdef*{
            valley
        }
    \end{dictentry}
    \begin{dictentry}{\famword{TuLWaw}}{n., adv.}
        \dictdef{
            the right hand
        }
        \dictdef{
...
\begin{dictroot}{w}{b}
    ...
    \begin{dictentry}{WiWiyaB}{v.tr.}
        \dictdef*{
            to deliver, bring, send \textit{smth.}
        }
    \end{dictentry}
