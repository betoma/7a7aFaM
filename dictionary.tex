...
\begin{dictroot}{b}{rd}
    %bird
    \begin{dictentry}{BaRD}{n.}
        \dictdef*{
            flight
        }
    \end{dictentry}
    \begin{dictentry}{BiiRD}{v.tr}
        \dictdef{
    ...
    \end{dictentry}
    \begin{dictentry}{iBaaRD}{v.intr}
        \dictdef*{
            to fly, to fly around
        }
    \end{dictentry}
    \begin{dictentry}{BiBiyaRD}{v.tr.}
        \dictdef{
    ...
    \end{dictentry}
    \begin{dictentry}{aaBiRD}{v.tr.}
        \dictdef{
            to pilot \textit{smth.}
        }
    \end{dictentry}
    \begin{dictentry}{BaRDa}{adj.}
        \dictdef{
            airborne
        }
        \dictdef{
    ...
    \end{dictentry}
    \begin{dictentry}{BanaRD}{n.}
        \dictdef{
            acrobat, trapeze artist, tumbler, gymnast
        }
    \end{dictentry}
    \begin{dictentry}{BuRDi}{n.}
        \dictdef*{
            bullet, cannonball, projectile
        }
    \end{dictentry}
    \begin{dictentry}{iBuRDa}{n.}
        \dictdef*{
            airport
        }
    \end{dictentry}
    \begin{dictentry}{mBiRD}{n.}
        \dictdef{
    ...
    \end{dictentry}
    \begin{dictentry}{BasiRD}{n.}
        \dictdef{
            arrow, bolt, long thin projectile
        }
    \end{dictentry}
    \begin{dictentry}{BajuRDa}{n.}
        \dictdef{
    ...
    \end{dictentry}
    \begin{dictentry}{aBiRDu}{n.}
        \dictdef*{
            bird's nest
        }
    \end{dictentry}
    \begin{dictentry}{BimiRDu}{n.}
        \dictdef{
            cage, bird cage
        }
    \end{dictentry}
    \dictsubtitle{Compounds \& Secondary Derivations}
    \begin{dictentry}{aaBiRDana}{n.}
        \dictdef{
...
\begin{dictroot}{dr}{j}
    \begin{dictentry}{DRaJ}{n.}
        \dictdef*{magic, witchcraft}
        \dictdef*{a magic spell, a magical curse}
    \end{dictentry}
    \begin{dictentry}{DRiiJ}{v.tr}
        \dictdef*{to cast a spell on \textit{smth. or sme.}}
    \end{dictentry}
    \begin{dictentry}{DRanaJ}{n.}
        \dictdef*{witch, druid, sorcerer, wizard}
    \end{dictentry}
    \begin{dictentry}{DRuuJ}{n.}
        \dictdef{pagan people group(s), pagan people(s)}
        \dictdef{pagan, practicer of pagan religious practices}
    \end{dictentry}
\end{dictroot}
...
\begin{dictroot}{dr}{p}
    ...
    \end{dictentry}
    \begin{dictentry}{DRiDRiyaP}{v.tr.}
        \dictdef{
...
\begin{dictroot}{j}{n}
    \begin{dictentry}{JiiN}{v.tr.}
        \dictdef*{to take a break from \textit{smth.}, to take a vacation from \textit{smth.}}
    \end{dictentry}
    \begin{dictentry}{JiyaN}{v.intr.}
        \dictdef*{to rest, to relax, to be resting, to destress}
    \end{dictentry}
    \begin{dictentry}{iJaaN}{v.intr.}
        \dictdef{to wait}
        \dictdef{to lie down, to relax, to begin napping, to lie down with the intent to relax}
    \end{dictentry}
    \begin{dictentry}{JiJiyaN}{v.tr.}
        \dictdef*{to relax \textit{sme.}, to calm \textit{sme.} down, to destress \textit{sme.}}
    \end{dictentry}
    \begin{dictentry}{aaJiN}{v.tr.}
        \dictdef{to give \textit{sme.} a break, to give \textit{sme.} a vacation}
        \dictdef{to pause \textit{smth.}}
    \end{dictentry}
\end{dictroot}
