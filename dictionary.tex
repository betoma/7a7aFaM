...
\begin{dictroot}{c}{j}
    ...
    \begin{dictentry}{CiiY}{v.tr.}
        \dictdef*{to hurry over \textit{smth.}, to rush \textit{smth.}, to do \textit{smth.} in a hurry}
    \end{dictentry}
    \begin{dictentry}{CiyaJ}{v.intr.}
        \dictdef*{to be hurried, to be rushed, to be expedited}
    \end{dictentry}
    \begin{dictentry}{iCaaJ}{v.intr.}
        \dictdef*{to hurry, to rush, to make haste, to be quick about things}
    \end{dictentry}
    \begin{dictentry}{CiCiyaJ}{v.tr.}
        \dictdef*{to hasten \textit{smth.}, to cause \textit{smth.} to be rushed, to expedite, to cut corners on \textit{smth.}}
    \end{dictentry}
